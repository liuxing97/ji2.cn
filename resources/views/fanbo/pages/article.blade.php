...
<div class="content">
    <div class="content-header">
        <h3 class="articletitle"><i class="layui-icon layui-icon-read"></i>10个必备的移动UI射击资源站</h3>
        <div class="release_time">2018-09-07 12:25:23</div>
        <hr class="articletitle_hr">
    </div>
    <div class="content-words">
        <div class="describe"><span>描述：</span>千图网收集了新的矢量图片,ps素材库,网页素材库,图片素材库,ppt素材库等图片素材供用户高速下载
            <hr>
        </div>
        <div class="content_main">
            <span class="content_main_title">正文：</span>
            <p><a href="">从这里进入购买链接</a></p>
        </div>
    </div>
</div>
<div class="more_article">
    <div class="more_article_title">更多咨询</div>
