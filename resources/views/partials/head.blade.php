...
<!-- Ionicons -->
<link rel="stylesheet" href="/css/ionicons.2.0.0.min.css">
<!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
<!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
<!--[if lt IE 9]>
<script src="/js/html5shiv.2.7.3.min.js"></script>
...
<link rel="stylesheet" type="text/css" href="/module/select/css/selectFilter.css" />